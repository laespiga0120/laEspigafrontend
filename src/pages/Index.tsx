...
const mockProducts = [
  { id: 1, nombre: "Arroz Blanco", categoria: "Granos", stock: 150, stockMinimo: 50, ubicacion: { repisa: "A", fila: "1", nivel: "2" } },
  { id: 2, nombre: "Frijol Negro", categoria: "Granos", stock: 80, stockMinimo: 30, ubicacion: { repisa: "A", fila: "2", nivel: "1" } },
  { id: 3, nombre: "Aceite Vegetal", categoria: "Aceites", stock: 45, stockMinimo: 20, ubicacion: { repisa: "B", fila: "1", nivel: "3" } },
  { id: 4, nombre: "Azúcar Blanca", categoria: "Endulzantes", stock: 200, stockMinimo: 100, ubicacion: { repisa: "C", fila: "3", nivel: "1" } },
  { id: 5, nombre: "Sal de Mesa", categoria: "Condimentos", stock: 120, stockMinimo: 40, ubicacion: { repisa: "C", fila: "2", nivel: "2" } },
  { id: 6, nombre: "Harina de Trigo", categoria: "Harinas", stock: 90, stockMinimo: 50, ubicacion: { repisa: "B", fila: "3", nivel: "1" } },
  { id: 7, nombre: "Pasta Corta", categoria: "Pastas", stock: 60, stockMinimo: 25, ubicacion: { repisa: "D", fila: "1", nivel: "2" } },
  { id: 8, nombre: "Leche Entera", categoria: "Lácteos", stock: 35, stockMinimo: 20, ubicacion: { repisa: "E", fila: "2", nivel: "3" } },
];
...
const Index = () => {
  ...
  const filteredProducts = mockProducts.filter((product) => {
    const matchesName = product.nombre.toLowerCase().includes(searchName.toLowerCase());
    const matchesCategory = selectedCategory === "Todas" || product.categoria === selectedCategory;
    const matchesRepisa = searchRepisa === "" || product.ubicacion.repisa.toLowerCase().includes(searchRepisa.toLowerCase());
    const matchesFila = searchFila === "" || product.ubicacion.fila.toLowerCase().includes(searchFila.toLowerCase());
            ...
            <div className="mb-6 lg:ml-0 ml-14">
              <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {/* Filtro por repisa */}
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground">Repisa</label>
                    <Input
                  ...
                  {/* Filtro por fila */}
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground">Fila</label>
                    <Input
